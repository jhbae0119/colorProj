    ...
    <div class="login_tistory">
        ...
        <form method="post" id="authForm" action="./join">
            ...
            <div class="box_login">
                ...
                <div class="inp_text">
                <label for="loginId" class="screen_out">이메일주소</label>
                <input type="email" id="email" name="email" placeholder="Email" >
				</div>
                 
               <!--  <div class="inp_text">
	                <label for="loginId" class="screen_out">오늘의 기분</label>
	                <select name="mood">
	                	<option disabled="disabled">오늘의 기분</option>
						<option>happy</option>
						<option>bored</option>
            ...
            <button type="submit" class="move_join">회원가입</button>
